...
namespace TaskHub.API.Migrations
{
    ...
    [Migration("20260704092337_AddDigestDrafts")]
    partial class AddDigestDrafts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskHub.API.Models.DigestDraft", b =>
                {
                    b.Property<int>("DigestDraftID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DigestDraftID"));
                    ...
                    b.HasKey("DigestDraftID");

                    b.HasIndex("UserID")
                        .IsUnique();

                    b.ToTable("DigestDrafts");
                });

            modelBuilder.Entity("TaskHub.API.Models.DigestEntry", b =>
                {
                    b.Property<int>("DigestEntryID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("DigestEntryID"));
